			...
			<legend class="label label-warning"><strong>Daftar Pusat Bertauliah</strong></legend>
					...
					<span class="label label-success">Jenis PB</span>
						<div class="col-lg-6">
							...
							<select class="form-control" id="jenispb" name="jenispb">
								<option></option>
					...
					<div class="form-group">
						...
						<div class="col-lg-6">
							<textarea class="form-control" id="namapb" name="namapb" placeholder="Nama PB" style="text-transform: uppercase" type="text" maxlength="100" rows="3"></textarea>
						</div>
					</div>
					<div class="form-group">
						<span class="label label-success">No. Tel</span>
						<div class="col-lg-6">
							<input class="form-control" id="notel" name="notel" placeholder="No. Tel" type="text" maxlength="10">
					...
					<div class="form-group">
						...
						<div class="col-lg-6">
							<textarea class="form-control" id="alamatpb" name="alamatpb" placeholder="Alamat" style="text-transform: uppercase" type="text" maxlength="200" rows="3"></textarea>
						</div>
					</div>
				</fieldset><br>
